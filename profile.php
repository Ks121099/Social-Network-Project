	   ...
	   <?php
			   ...
			   while($row_posts = mysqli_fetch_array($run_posts)) {
				   ...
				   if(strlen($content) >=1 && strlen($upload_image) >= 1) {
					   ...
					   <br>					
						   <a href='single.php?post_id=$post_id' style='float:right; margin= 0px  15px 0px 15px;'>
						   <button class='btn btn-success'>View</button></a>
			   
					   <a href='functions/delete_post.php?post_id=$post_id' style='float:right; margin= 0px  15px 0px 15px;'>
					...
					<div id='own_posts'>
							...
							<div class='col-sm-6'>
								<h3>
									<a style='text-decoration:none; cursor:pointer; color:#3897f0'
										href='user_profile.php?u_id=$user_id'>$user_name</a>
								</h3>
								<h4>
									<small style='color:black'>Update a post on <strong>$post_date</strong></small>
								</h4>
						...
						<a href='functions/delete_post.php?post_id=$post_id' style='float:right; margin= 0px  15px 0px 15px;'><button
					...
					if($u_email != $user_email) {
						...
						echo "
							...
							<a href='edit_post.php?post_id=$post_id' style='float:right; margin-left=10px;'><button class='btn btn-info'>Edit</button></a>
			
							<a href='functions/delete_post.php?post_id=$post_id' style='float:right; margin-left=10px;'><button class='btn btn-danger'>Delete</button></a>
							</div><br><br><br>
						";
					}
